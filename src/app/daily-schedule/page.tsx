	...
	return (
		<div className="min-h-screen bg-white flex flex-col items-center p-4">
			...
			<div className="flex justify-between items-center w-full max-w-md mb-4">
				...
				<button
					className="flex items-center bg-green-200 text-green-800 py-2 px-4 rounded-lg shadow-md"
					onClick={goTo_task_list}
				>
			...
			>
				{Array.from({ length: 24 }).map((_, index) => (
					<div
						key={index}
						className="relative flex items-start border-t border-gray-200"
					>
